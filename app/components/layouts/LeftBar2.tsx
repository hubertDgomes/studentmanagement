...
const navLinks = [
  ...
  { label: "Class Schedules",     icon: "🗓️", href: "/admin-dashboard/schedule" },
  { label: "Exam Schedules",      icon: "📝", href: "/admin-dashboard/examschedule" },
  { label: "Lab & Resources",     icon: "🔬", href: "/admin-dashboard/labschedule" },
  { label: "Notice & Announcements", icon: "📢", href: "/admin-dashboard/notice" },
]
  ...
  return (
    <div className="w-64 min-h-screen bg-base-100 border-r border-base-300 flex flex-col">
      ...
      <div className="p-5 border-b border-base-300">
        <p className="text-xs font-semibold text-base-content/40 uppercase tracking-widest mb-1">Admin Panel</p>
